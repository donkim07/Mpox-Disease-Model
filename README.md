...
1. Clone the repository using `git clone https://github.com/your-username/Mpox-Disease-Model.git`
...
* [List any acknowledgments, e.g. funding agencies, collaborators, etc.]
